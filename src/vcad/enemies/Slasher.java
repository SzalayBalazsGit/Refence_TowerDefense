...
public class Slasher extends Enemy {
    ...
    //Közepesen eros és közepes sebességű ellenfél.
     //@param waypoints - az utvonalnak a pontjai
    //@param id - azonosito
    public Slasher(ArrayList<Vector2> waypoints, int id) {
        super(waypoints, id);
        currentWPC = 1;
    ...
    public void render(Graphics g) {
        if (alive && !finished) {
            g.drawImage(Assets.Slasher, (int) position.getX() - 40, (int) position.getY() - 100, null);
            renderStat(g, 110);
        }
